# Demonstrate the protection of the Secure Execution-enabled HPVS 2.1.4.1 guest

## Overview of this section

In this section you will demonstrate the protection offered by the Secure Execution-enabled HPVS 2.1.4.1 guest in contrast to the ease in which a malicious insider can eavesdrop on a standard KVM guest.
...
## Go ahead and try to hack me says the HPVS 2.1.4.1 guest

Try to snoop on your Secure Execution-enabled Hyper Protect Virtual Servers 2.1.4.1 guest that is running your GREP11 Server. See what happens:

...
1. client certificate for your (not-yet-created) HPVS 2.1.5 GREP11 Server
...
3. Create a configuration file:
	...
	CN = SE-enabled HPVS 2.1.5 Grep11 Server
...
9. You will do your due diligence and check the contents of the CSR:
	...
	???- example "Example human-readable display of CSR"
		...
		Certificate Request:
			Data:
				Version: 1 (0x0)
				Subject: C = US, O = IBM WSC IBM Z and LinuxONE, CN = SE-enabled HPVS 2.1.5 Grep11 Server
...
Click the _Next_ link at the bottom of the page to continue to the next part of the lab, where you will create the _contract_ that HPVS 2.1.5 expects, so that you can run your GREP11 Server.

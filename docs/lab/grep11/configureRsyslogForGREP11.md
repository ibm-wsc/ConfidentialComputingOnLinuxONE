...
1. client certificate for your (not-yet-created) HPVS 2.1.6 GREP11 Server
...
Click the _Next_ link at the bottom of the page to continue to the next part of the lab, where you will create the _contract_ that HPVS 2.1.6 expects, so that you can run your GREP11 Server.

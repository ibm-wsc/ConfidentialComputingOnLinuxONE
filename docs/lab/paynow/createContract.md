...
Create a directory structure for creating an HPVS 2.1.4 contract:
...
Create the convenience script:
   ...
   #
   CONTRACT_KEY=/data/lab/hpvs214Certs/ibm-hyper-protect-container-runtime-23.3.0-encrypt.crt

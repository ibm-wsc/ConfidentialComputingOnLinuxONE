...
1. Give your instance a name in the *Name* field in the *Details* section.  We chose *lab-was-hpvs-lab1* in the screen shot below.  Then, it is very important to select the *Version* that ends in "*-10*"- you may have to select the field, then hover over the second entry to confirm that *ibm-hyper-protect-container-runtime-1-0-s390x-10* is selected.  The screen widget may be sized such that you cannot distinguish between the image ending in *-9* and the one ending in *-10* without the benefit of the tool tip that appears when you hover the mouse for a bit. Hopefully this screen snippet clarifies this:
